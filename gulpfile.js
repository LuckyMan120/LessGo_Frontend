...
gulp.task('deploy', ['build-cordova'], function () {
  ...
  // develop
    if (argv.develop) {
        ...
        rsyncConf.destination = '/home/movilizame/sites/lessgo_dev/public/dev/'; // path where uploaded files go
  ...
  // Production
        ...
        rsyncConf.hostname = '104.131.15.228'; // hostname
        rsyncConf.username = argv.user || 'movilizame'; // ssh username
        rsyncConf.destination = '/home/movilizame/sites/lessgo/public/app/'; // path where uploaded files go
