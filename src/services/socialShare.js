...
export default {
    share (options) {
    /* var options = {
        message: 'Aplicación para compartir trips de autos dentro de Argentina', // not supported on some apps (Facebook, Instagram)
        subject: 'Lessgo', // fi. for email
        files: [], // an array of filenames either locally or remotely
        url: 'https://lessgo.app/app',
        chooserTitle: 'Lessgo' // Android only, you can override the default share sheet title
    } */
