...
const getters = {
    ...
    driverTrips: state => state.driverTrips,
...
const actions = {
    ...
    setTrips (store, data) {
        store.commit(types.SET_TRIPS, data);
    },
    setSelectedTrip (store, data) {
        store.commit(types.SET_SELECTED_TRIP, data);
    }
};
...
const mutations = {
    ...
    [types.SET_TRIPS] (state, data) {
        state.driverTrips = data;
    },

    [types.SET_SELECTED_TRIP] (state, trip) {
