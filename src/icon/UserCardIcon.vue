<template>
    <svg :style="{'width': size}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 46.676 46.675" style="enable-background:new 0 0 46.676 46.675;"
     xml:space="preserve">
<g>
    <path :style="{'fill': fillcolor}" d="M42.176,6.318H4.5c-2.484,0-4.5,2.015-4.5,4.5v25.04c0,2.485,2.016,4.5,4.5,4.5h37.676c2.485,0,4.5-2.015,4.5-4.5v-25.04
