<template>
    <svg :width="size" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 511.763 511.763" style="enable-background:new 0 0 511.763 511.763; transform: rotate(45deg)" xml:space="preserve">
<g>
    <g>
        <path :style="{'fill': color}" d="M511.716,9.802c-0.107-0.853-0.213-1.707-0.533-2.56c-0.107-0.32-0.213-0.747-0.32-1.067
