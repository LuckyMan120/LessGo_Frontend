...
class Notification {
    constructor (e) {
        ...
        if (e) {
      // The application is open and on screen
        ...
        let push = window.PushNotification.init({
            ...
            ios: {
                ...
                'categories': {
                    'taxi': {
                        'yes': {
                            'callback': 'app.acceptTrip', 'title': 'Accept', 'foreground': false, 'destructive': false
                        },
                        'no': {
                            'callback': 'app.rejectTrip', 'title': 'Reject', 'foreground': false, 'destructive': true
                        }
                    }
                }
            },
