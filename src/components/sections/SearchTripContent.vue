            ...
            <div class="contentcontainer">
                ...
                <div class="textboxscontainer">
                    <div class="from fromtocommon">
                        ...
                        <OsmAutocomplete placeholder="Leaving from" :value="from_town.name"
                        ...
                        font-weight: bold;
                        border-bottom: 3px solid #f0f8f6;
                        ">
                    ...
                    <div class="swap btn">
                        <reserveIcon :class="'swap-vertical reserve-img'" @reserve="swapCities"></reserveIcon>
                    </div>
                    ...
                    <DatePicker ref="datepicker" :value="date" :minDate="minDate" :class="{'has-error': dateError.state}" @onChange="changeDate"></DatePicker>
...
import reserveIcon from '../../icon/reserveIcon.vue';
