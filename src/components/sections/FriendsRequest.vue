    ...
    <div class="clearfix">
        ...
        <li class="list-group-item">
            <div class="input-group">
                <input v-model="text" v-debounceInput="onTextChange" type="text" class="form-control" id="input-name" placeholder="Search people">
                        ...
                        <div class="media-right">
                            <button @click="onAddClick(user)" :class="user.state === 'none' ? 'btn-primary' : ''" class="btn" :disabled="user.state != 'none'">
                                <span v-if="user.state == 'none' && !idRequesting[user.id]">
                                    Add as Friend <i class="fa fa-plus" aria-hidden="true"></i>
                                </span>
                                <span v-if="idRequesting[user.id] && idRequesting[user.id] === true"><spinner class="blue"></spinner></span>
                                <span v-if="user.state != 'none'"> Request sent </span>
                            </button>
                        </div>
                    </div>
                </li>
